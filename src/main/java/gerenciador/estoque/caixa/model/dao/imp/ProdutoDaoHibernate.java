...
public class ProdutoDaoHibernate implements ProdutoDao {
    ...
    public ProdutoDTO retornaProdutoDTOPorCodigo(String codigo) {
        ...
        try {
            String jpql = "SELECT new main.java.gerenciador.estoque.caixa.dtos.produtos.ProdutoDTO(" +
    ...
    public ProdutoAtualizarQuantidadeDTO retornaProdutoAtualizarQuantidadeDTO(String codigo) {
        ...
        try {
            String jpql = "SELECT new main.java.gerenciador.estoque.caixa.dtos.produtos.ProdutoAtualizarQuantidadeDTO(p.quantidade) " +
                    "FROM Produto p " +
                    "WHERE p.codigoDeBarra = :codigoDeBarra";
    ...
    public List<ProdutoResponseDTO> retornaProdutosPorCategoria(Integer idCategoria) {
        ...
        try {
            String jpql = "SELECT new main.java.gerenciador.estoque.caixa.dtos.produtos.ProdutoResponseDTO(p.codigoDeBarra, p.nome) "
    ...
    public List<ProdutoBaixoEstoqueResponseDTO> retornaProdutosEstoqueBaixo() {
        ...
        try {
            String jpql = "SELECT new main.java.gerenciador.estoque.caixa.dtos.produtos.ProdutoBaixoEstoqueResponseDTO(p.codigoDeBarra, p.nome, p.quantidade) "
